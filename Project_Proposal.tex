...
Using Deep Learning to Predict Cardiac Events from ICU Vitals}


%######## APS360: Put your names, student IDs and Emails here
\author{Bharat Bhargava  \\
Student\# 1010380892\\
\texttt{bharat.bhargava@mail.utoronto.ca} \\
\And
Author Two  \\
Student\# 1005678901 \\
...
Michael Silver \\
Student\# 1009119678 \\
\texttt{m.silver@mail.utoronto.ca} \\
\AND
}
...
\begin{abstract}
We aim to build a CNN-LSTM hybrid deep learning model model that uses common and accessible medical metrics to predict whether and what type of cardiac event will occur in ICU patients, based on the MIMIC Database.
